...
namespace Graphene.Utils
{
    ...
    public static class RobertPannerEasingLerp
    {
        public static float Evaluate(float time, float duration, float from, float to, Equations equation, AnimationCurve curve = null)
        {
            switch (equation)
            {
                case Equations.Linear:
                    ...
                    break;
                case Equations.CustomCurve:
                    return CustomCurve(time, from, to, duration, curve);
                    break;
        ...
        private static float CustomCurve(float t, float b, float c, float d, AnimationCurve curve)
        {
            return curve == null ? c : curve.Evaluate(Linear(t,b,c,d));
        }
